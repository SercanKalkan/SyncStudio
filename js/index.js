...
new Swiper('#projects .swiper-container', {
  ...
  observeParents: true,
   ...
   $(function(){
    ...
    $('.hizmet-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('#hizmet',0,{display:'block',delay:.7})
      gsap.to('#hizmet',.5,{scale:1,delay:1.1})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
      gsap.from('.hizmet-opacity',1,{opacity:0,delay:1.6,stagger:.2})
    })
    $('.hizmet-link-about').on('click',function(){
      gsap.to('#about',.5,{scale:.9});
      gsap.to('#about',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#about',0,{display:'none',delay:.7});
      gsap.to('#hizmet',0,{display:'block',delay:.7})
     ...
     $('.home-link').on('click',function(){
      ...
      gsap.to('#hizmet',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#hizmet',0,{display:'none',delay:.7});
    ...
    $('.hizmet-close').on('click',function(){
      gsap.to('#hizmet',.5,{scale:.9});
      gsap.to('#hizmet',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#hizmet',0,{width:'100%',height:'auto',overflow:'hidden',delay:1.7});
      gsap.to('#hizmet',0,{display:'none',delay:.7});
      gsap.to('#home',0,{display:'block',delay:.7})
      gsap.to('#home',.5,{scale:1,delay:1.1})
      gsap.to('#breaker',{display:'block'})
